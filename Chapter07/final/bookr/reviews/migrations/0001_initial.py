# Generated by Django 5.1 on 2025-02-23 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_names', models.CharField(blank=True, help_text="The contributor's last name or names.", max_length=50)),
                ('email', models.EmailField(blank=True, help_text='The contact email for the contributor.', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Publisher',
            fields=[
                ...
                ('email', models.EmailField(blank=True, help_text="The Publisher's email address.", max_length=254)),
            ],
        ),
        migrations.CreateModel(
